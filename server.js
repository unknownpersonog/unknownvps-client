    ...
    <div class="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
      ...
      <div class="relative transform overflow-hidden rounded-lg text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg">
        ...
        <div style="padding-top: 8px;" class="px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
          <a href="https://discord.com/api/oauth2/authorize?client_id=1058719156691795989&redirect_uri=https%3A%2F%2Fclient.unknownnodes.ml%2Flogin&response_type=code&scope=identify%20guilds%20email" type="button" class="inline-flex w-full justify-center rounded-md border border-transparent bg-blue-600 px-4 py-2 text-base font-medium text-white shadow-sm hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 sm:ml-3 sm:w-auto sm:text-sm">Login using Discord</a>
